...
A Next.js project generated from [https://vesteira.framer.ai/](https://vesteira.framer.ai/) by [FNJ](https://framertonextjs.com).

## What this is

21 page(s) built from 228 React section component(s). Unlike a
...
src/app/           route handlers that serve the prerendered HTML
