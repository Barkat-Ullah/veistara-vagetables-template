...
import View from "../../views/PrivacyPolicyPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("privacy-policy.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "privacy-policy.html"), "utf8");
