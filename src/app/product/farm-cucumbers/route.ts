...
import View from "../../../views/ProductFarmCucumbersPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("product-farm-cucumbers.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "product-farm-cucumbers.html"), "utf8");
