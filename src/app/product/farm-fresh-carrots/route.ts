...
import View from "../../../views/ProductFarmFreshCarrotsPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("product-farm-fresh-carrots.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "product-farm-fresh-carrots.html"), "utf8");
