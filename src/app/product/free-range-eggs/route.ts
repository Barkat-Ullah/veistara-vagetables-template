...
import View from "../../../views/ProductFreeRangeEggsPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("product-free-range-eggs.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "product-free-range-eggs.html"), "utf8");
