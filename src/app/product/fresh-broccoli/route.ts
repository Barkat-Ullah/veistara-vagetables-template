...
import View from "../../../views/ProductFreshBroccoliPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("product-fresh-broccoli.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "product-fresh-broccoli.html"), "utf8");
