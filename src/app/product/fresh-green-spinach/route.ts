...
import View from "../../../views/ProductFreshGreenSpinachPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("product-fresh-green-spinach.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "product-fresh-green-spinach.html"), "utf8");
