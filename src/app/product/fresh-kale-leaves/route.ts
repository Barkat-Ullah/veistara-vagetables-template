...
import View from "../../../views/ProductFreshKaleLeavesPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("product-fresh-kale-leaves.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "product-fresh-kale-leaves.html"), "utf8");
