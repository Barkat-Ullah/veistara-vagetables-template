...
import View from "../../../views/ProductGoldenSweetCornPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("product-golden-sweet-corn.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "product-golden-sweet-corn.html"), "utf8");
