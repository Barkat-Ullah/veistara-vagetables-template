...
import View from "../../../views/ProductOrganicBananasPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("product-organic-bananas.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "product-organic-bananas.html"), "utf8");
