...
import View from "../../../views/ProductOrganicRedApplesPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("product-organic-red-apples.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "product-organic-red-apples.html"), "utf8");
