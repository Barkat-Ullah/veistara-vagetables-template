...
import View from "../../../views/ProductOrganicStrawberriesPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("product-organic-strawberries.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "product-organic-strawberries.html"), "utf8");
