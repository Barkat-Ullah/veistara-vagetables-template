...
import View from "../../../views/ProductOrganicTomatoesPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("product-organic-tomatoes.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "product-organic-tomatoes.html"), "utf8");
