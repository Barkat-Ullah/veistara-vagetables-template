...
import View from "../../views/TermsAndConditionPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("terms-and-condition.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "terms-and-condition.html"), "utf8");
