...
import Header from "@/src/sections/about/Header";
import Header2 from "@/src/sections/about/Header2";
import Header3 from "@/src/sections/about/Header3";
import Banner from "@/src/sections/about/Banner";
import Card from "@/src/sections/about/Card";
import Cta from "@/src/sections/about/Cta";
import Card2 from "@/src/sections/about/Card2";
import Cta2 from "@/src/sections/about/Cta2";
import Footer from "@/src/sections/about/Footer";
import Footer2 from "@/src/sections/about/Footer2";
import Footer3 from "@/src/sections/about/Footer3";
...
export default function AboutPage() {
  return (
    <body>
      ...
      {"\n\t\n\t"}
      <div id="main" data-framer-hydrate-v2={"{\"routeId\":\"KzJkzePOQ\",\"localeId\":\"default\",\"breakpoints\":[{\"hash\":\"m0w2tc\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1vf0j8g\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"1xglh5r\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"kxh8ir\",\"mediaQuery\":\"(max-width: 809.98px)\"},{\"hash\":\"22qbl\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1frv160\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"83oeot\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1wyxcdt\",\"mediaQuery\":\"(max-width: 809.98px)\"}]}"} data-framer-ssr-released-at="2026-08-06T12:57:44.116Z" data-framer-page-optimized-at="2026-08-07T04:38:26.657Z" data-framer-generated-page="">
        <Suspense fallback={null}>
          ...
          <div className="framer-Q2Ors framer-QrPZX framer-mkgQP framer-4RXUR framer-SQy1v framer-xo5li framer-xbNaX framer-22qbl" data-layout-template="true" style={{ "--hgcs32": "hidden", minHeight: "100vh", width: "auto" }}>
            ...
            <div data-framer-root="" className="framer-EGJjM framer-kRbhw framer-6V03H framer-mkgQP framer-QrPZX framer-5ka58 framer-gH0b7 framer-JLgb2 framer-m0w2tc" style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
              <div className="framer-2m74qz-container">
                <Suspense fallback={null}>
