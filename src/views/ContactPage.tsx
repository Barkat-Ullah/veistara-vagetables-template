...
import Header from "@/src/sections/contact/Header";
import Header2 from "@/src/sections/contact/Header2";
import Header3 from "@/src/sections/contact/Header3";
import Contact from "@/src/sections/contact/Contact";
import Contact2 from "@/src/sections/contact/Contact2";
import Cta from "@/src/sections/contact/Cta";
import Footer from "@/src/sections/contact/Footer";
import Footer2 from "@/src/sections/contact/Footer2";
import Footer3 from "@/src/sections/contact/Footer3";

/** The "/contact" page, composed from its Framer sections.
 *
...
export default function ContactPage() {
  return (
    <body>
      ...
      {"\n\t\n\t"}
      <div id="main" data-framer-hydrate-v2={"{\"routeId\":\"FqdtzB3Qn\",\"localeId\":\"default\",\"breakpoints\":[{\"hash\":\"17cnp6y\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1by3vra\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"q3nvdf\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"fb0t8g\",\"mediaQuery\":\"(max-width: 809.98px)\"},{\"hash\":\"22qbl\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1frv160\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"83oeot\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1wyxcdt\",\"mediaQuery\":\"(max-width: 809.98px)\"}]}"} data-framer-ssr-released-at="2026-08-06T12:57:44.116Z" data-framer-page-optimized-at="2026-08-07T04:38:26.710Z" data-framer-generated-page="">
        <Suspense fallback={null}>
          ...
          <div className="framer-Q2Ors framer-QrPZX framer-mkgQP framer-4RXUR framer-SQy1v framer-xo5li framer-xbNaX framer-22qbl" data-layout-template="true" style={{ "--hgcs32": "hidden", minHeight: "100vh", width: "auto" }}>
            ...
            <div data-framer-root="" className="framer-VNegq framer-kRbhw framer-mkgQP framer-QrPZX framer-ROG8E framer-Adf4f framer-pb445 framer-4RXUR framer-17cnp6y" style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
              <div className="framer-1kkic59-container">
                <Suspense fallback={null}>
