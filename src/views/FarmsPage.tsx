...
import Header from "@/src/sections/farms/Header";
import Header2 from "@/src/sections/farms/Header2";
import Header3 from "@/src/sections/farms/Header3";
import Banner from "@/src/sections/farms/Banner";
import Features from "@/src/sections/farms/Features";
import Card from "@/src/sections/farms/Card";
import Farm from "@/src/sections/farms/Farm";
import Gallery from "@/src/sections/farms/Gallery";
import Cta from "@/src/sections/farms/Cta";
import Footer from "@/src/sections/farms/Footer";
import Footer2 from "@/src/sections/farms/Footer2";
import Footer3 from "@/src/sections/farms/Footer3";

/** The "/farms" page, composed from its Framer sections.
 *
...
export default function FarmsPage() {
  return (
    <body>
      ...
      {"\n\t\n\t"}
      <div id="main" data-framer-hydrate-v2={"{\"routeId\":\"NoSr086aZ\",\"localeId\":\"default\",\"breakpoints\":[{\"hash\":\"1pd5viu\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"j7ptuv\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"1r4568l\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1b2hv0b\",\"mediaQuery\":\"(max-width: 809.98px)\"},{\"hash\":\"22qbl\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1frv160\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"83oeot\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1wyxcdt\",\"mediaQuery\":\"(max-width: 809.98px)\"}]}"} data-framer-ssr-released-at="2026-08-06T12:57:44.116Z" data-framer-page-optimized-at="2026-08-07T04:38:26.722Z" data-framer-generated-page="">
        <Suspense fallback={null}>
          ...
          <div className="framer-Q2Ors framer-QrPZX framer-mkgQP framer-4RXUR framer-SQy1v framer-xo5li framer-xbNaX framer-22qbl" data-layout-template="true" style={{ "--hgcs32": "visible", minHeight: "100vh", width: "auto" }}>
            ...
            <div data-framer-root="" className="framer-RUEcm framer-kRbhw framer-6V03H framer-QrPZX framer-mkgQP framer-j4K01 framer-1pd5viu" style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
              <div className="framer-xgvlul-container">
                <Suspense fallback={null}>
