...
import Header from "@/src/sections/privacy-policy/Header";
import Header2 from "@/src/sections/privacy-policy/Header2";
import Header3 from "@/src/sections/privacy-policy/Header3";
import Terms from "@/src/sections/privacy-policy/Terms";
import Cta from "@/src/sections/privacy-policy/Cta";
import Footer from "@/src/sections/privacy-policy/Footer";
import Footer2 from "@/src/sections/privacy-policy/Footer2";
import Footer3 from "@/src/sections/privacy-policy/Footer3";

/** The "/privacy-policy" page, composed from its Framer sections.
 *
...
export default function PrivacyPolicyPage() {
  return (
    <body>
      ...
      {"\n\t\n\t"}
      <div id="main" data-framer-hydrate-v2={"{\"routeId\":\"zW6O_UzJY\",\"localeId\":\"default\",\"breakpoints\":[{\"hash\":\"1r9pb96\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"igqxoj\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"mzmzsa\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"6ofkb8\",\"mediaQuery\":\"(max-width: 809.98px)\"},{\"hash\":\"22qbl\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1frv160\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"83oeot\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1wyxcdt\",\"mediaQuery\":\"(max-width: 809.98px)\"}]}"} data-framer-ssr-released-at="2026-08-06T12:57:44.116Z" data-framer-page-optimized-at="2026-08-07T17:03:44.441Z" data-framer-generated-page="">
        <Suspense fallback={null}>
          ...
          <div className="framer-Q2Ors framer-QrPZX framer-mkgQP framer-4RXUR framer-SQy1v framer-xo5li framer-xbNaX framer-22qbl" data-layout-template="true" style={{ "--hgcs32": "hidden", minHeight: "100vh", width: "auto" }}>
            ...
            <div data-framer-root="" className="framer-W5ujy framer-kRbhw framer-mkgQP framer-JLgb2 framer-xbNaX framer-1r9pb96" style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
              <div className="framer-z2wp4v-container">
                <Suspense fallback={null}>
