...
import Header from "@/src/sections/product-fresh-green-spinach/Header";
import Header2 from "@/src/sections/product-fresh-green-spinach/Header2";
import Header3 from "@/src/sections/product-fresh-green-spinach/Header3";
import Post from "@/src/sections/product-fresh-green-spinach/Post";
import Card from "@/src/sections/product-fresh-green-spinach/Card";
import Card2 from "@/src/sections/product-fresh-green-spinach/Card2";
import Testimonial from "@/src/sections/product-fresh-green-spinach/Testimonial";
import Products from "@/src/sections/product-fresh-green-spinach/Products";
import Cta from "@/src/sections/product-fresh-green-spinach/Cta";
import Footer from "@/src/sections/product-fresh-green-spinach/Footer";
import Footer2 from "@/src/sections/product-fresh-green-spinach/Footer2";
import Footer3 from "@/src/sections/product-fresh-green-spinach/Footer3";

/** The "/product/fresh-green-spinach" page, composed from its Framer sections.
 *
...
export default function ProductFreshGreenSpinachPage() {
  return (
    <body>
      {"\n\t\n\t"}
      ...
      {"\n\t\n\t"}
      <div id="main" data-framer-hydrate-v2={"{\"routeId\":\"g2NYg495d\",\"localeId\":\"default\",\"pathVariables\":{\"Ub9xSoaj5\":\"fresh-green-spinach\"},\"breakpoints\":[{\"hash\":\"azdhhy\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1cdu622\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"1s9tetc\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1sy4kf0\",\"mediaQuery\":\"(max-width: 809.98px)\"},{\"hash\":\"22qbl\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1frv160\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"83oeot\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1wyxcdt\",\"mediaQuery\":\"(max-width: 809.98px)\"}],\"collectionItemId\":\"eSnFzXkQW\"}"} data-framer-ssr-released-at="2026-08-06T12:57:44.116Z" data-framer-page-optimized-at="2026-08-07T04:38:26.551Z" data-framer-generated-page="">
        <Suspense fallback={null}>
          ...
          <div className="framer-Q2Ors framer-QrPZX framer-mkgQP framer-4RXUR framer-SQy1v framer-xo5li framer-xbNaX framer-22qbl" data-layout-template="true" style={{ "--hgcs32": "hidden", minHeight: "100vh", width: "auto" }}>
            ...
            <div data-framer-root="" className="framer-Xf1L2 framer-6V03H framer-mkgQP framer-Adf4f framer-JLgb2 framer-j4K01 framer-ajOLe framer-xo5li framer-QrPZX framer-azdhhy" style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
              <div className="framer-8nff0e-container">
                <Suspense fallback={null}>
