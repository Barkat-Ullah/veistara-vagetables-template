...
import Header from "@/src/sections/product-fresh-kale-leaves/Header";
import Header2 from "@/src/sections/product-fresh-kale-leaves/Header2";
import Header3 from "@/src/sections/product-fresh-kale-leaves/Header3";
import Post from "@/src/sections/product-fresh-kale-leaves/Post";
import Card from "@/src/sections/product-fresh-kale-leaves/Card";
import Card2 from "@/src/sections/product-fresh-kale-leaves/Card2";
import Testimonial from "@/src/sections/product-fresh-kale-leaves/Testimonial";
import Products from "@/src/sections/product-fresh-kale-leaves/Products";
import Cta from "@/src/sections/product-fresh-kale-leaves/Cta";
import Footer from "@/src/sections/product-fresh-kale-leaves/Footer";
import Footer2 from "@/src/sections/product-fresh-kale-leaves/Footer2";
import Footer3 from "@/src/sections/product-fresh-kale-leaves/Footer3";

/** The "/product/fresh-kale-leaves" page, composed from its Framer sections.
 *
...
export default function ProductFreshKaleLeavesPage() {
  return (
    <body>
      {"\n\t\n\t"}
      ...
      {"\n\t\n\t"}
      <div id="main" data-framer-hydrate-v2={"{\"routeId\":\"g2NYg495d\",\"localeId\":\"default\",\"pathVariables\":{\"Ub9xSoaj5\":\"fresh-kale-leaves\"},\"breakpoints\":[{\"hash\":\"azdhhy\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1cdu622\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"1s9tetc\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1sy4kf0\",\"mediaQuery\":\"(max-width: 809.98px)\"},{\"hash\":\"22qbl\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1frv160\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"83oeot\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1wyxcdt\",\"mediaQuery\":\"(max-width: 809.98px)\"}],\"collectionItemId\":\"k1Q3J4X4p\"}"} data-framer-ssr-released-at="2026-08-06T12:57:44.116Z" data-framer-page-optimized-at="2026-08-07T04:38:26.304Z" data-framer-generated-page="">
