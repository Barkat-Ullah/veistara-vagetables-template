...
import Header from "@/src/sections/product-golden-sweet-corn/Header";
import Header2 from "@/src/sections/product-golden-sweet-corn/Header2";
import Header3 from "@/src/sections/product-golden-sweet-corn/Header3";
import Post from "@/src/sections/product-golden-sweet-corn/Post";
import Card from "@/src/sections/product-golden-sweet-corn/Card";
import Card2 from "@/src/sections/product-golden-sweet-corn/Card2";
import Testimonial from "@/src/sections/product-golden-sweet-corn/Testimonial";
import Products from "@/src/sections/product-golden-sweet-corn/Products";
import Cta from "@/src/sections/product-golden-sweet-corn/Cta";
import Footer from "@/src/sections/product-golden-sweet-corn/Footer";
import Footer2 from "@/src/sections/product-golden-sweet-corn/Footer2";
import Footer3 from "@/src/sections/product-golden-sweet-corn/Footer3";

/** The "/product/golden-sweet-corn" page, composed from its Framer sections.
 *
...
export default function ProductGoldenSweetCornPage() {
  return (
    <body>
      {"\n\t\n\t"}
      ...
      {"\n\t\n\t"}
      <div id="main" data-framer-hydrate-v2={"{\"routeId\":\"g2NYg495d\",\"localeId\":\"default\",\"pathVariables\":{\"Ub9xSoaj5\":\"golden-sweet-corn\"},\"breakpoints\":[{\"hash\":\"azdhhy\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1cdu622\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"1s9tetc\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1sy4kf0\",\"mediaQuery\":\"(max-width: 809.98px)\"},{\"hash\":\"22qbl\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1frv160\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"83oeot\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1wyxcdt\",\"mediaQuery\":\"(max-width: 809.98px)\"}],\"collectionItemId\":\"zC8iHCxTp\"}"} data-framer-ssr-released-at="2026-08-06T12:57:44.116Z" data-framer-page-optimized-at="2026-08-08T07:20:30.583Z" data-framer-generated-page="">
