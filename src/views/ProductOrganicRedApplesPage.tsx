...
import Header from "@/src/sections/product-organic-red-apples/Header";
import Header2 from "@/src/sections/product-organic-red-apples/Header2";
import Header3 from "@/src/sections/product-organic-red-apples/Header3";
import Post from "@/src/sections/product-organic-red-apples/Post";
import Card from "@/src/sections/product-organic-red-apples/Card";
import Card2 from "@/src/sections/product-organic-red-apples/Card2";
import Testimonial from "@/src/sections/product-organic-red-apples/Testimonial";
import Products from "@/src/sections/product-organic-red-apples/Products";
import Cta from "@/src/sections/product-organic-red-apples/Cta";
import Footer from "@/src/sections/product-organic-red-apples/Footer";
import Footer2 from "@/src/sections/product-organic-red-apples/Footer2";
import Footer3 from "@/src/sections/product-organic-red-apples/Footer3";

/** The "/product/organic-red-apples" page, composed from its Framer sections.
 *
...
export default function ProductOrganicRedApplesPage() {
  return (
    <body>
      {"\n\t\n\t"}
      ...
      {"\n\t\n\t"}
      <div id="main" data-framer-hydrate-v2={"{\"routeId\":\"g2NYg495d\",\"localeId\":\"default\",\"pathVariables\":{\"Ub9xSoaj5\":\"organic-red-apples\"},\"breakpoints\":[{\"hash\":\"azdhhy\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1cdu622\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"1s9tetc\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1sy4kf0\",\"mediaQuery\":\"(max-width: 809.98px)\"},{\"hash\":\"22qbl\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1frv160\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"83oeot\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1wyxcdt\",\"mediaQuery\":\"(max-width: 809.98px)\"}],\"collectionItemId\":\"bU12xsELK\"}"} data-framer-ssr-released-at="2026-08-06T12:57:44.116Z" data-framer-page-optimized-at="2026-08-07T04:38:26.364Z" data-framer-generated-page="">
