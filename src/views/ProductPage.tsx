...
import Header from "@/src/sections/product/Header";
import Header2 from "@/src/sections/product/Header2";
import Header3 from "@/src/sections/product/Header3";
import Product from "@/src/sections/product/Product";
import Cta from "@/src/sections/product/Cta";
import Footer from "@/src/sections/product/Footer";
import Footer2 from "@/src/sections/product/Footer2";
import Footer3 from "@/src/sections/product/Footer3";

/** The "/product" page, composed from its Framer sections.
 *
...
export default function ProductPage() {
  return (
    <body>
      ...
      {"\n\t\n\t"}
      <div id="main" data-framer-hydrate-v2={"{\"routeId\":\"ZVqpId74f\",\"localeId\":\"default\",\"breakpoints\":[{\"hash\":\"xgaixr\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"17mt7hg\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"vzav97\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"ksq8t4\",\"mediaQuery\":\"(max-width: 809.98px)\"},{\"hash\":\"22qbl\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1frv160\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"83oeot\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1wyxcdt\",\"mediaQuery\":\"(max-width: 809.98px)\"}]}"} data-framer-ssr-released-at="2026-08-06T12:57:44.116Z" data-framer-page-optimized-at="2026-08-07T04:38:26.655Z" data-framer-generated-page="">
        <Suspense fallback={null}>
          ...
          <div className="framer-Q2Ors framer-QrPZX framer-mkgQP framer-4RXUR framer-SQy1v framer-xo5li framer-xbNaX framer-22qbl" data-layout-template="true" style={{ "--hgcs32": "hidden", minHeight: "100vh", width: "auto" }}>
            ...
            <div data-framer-root="" className="framer-SfNXQ framer-kRbhw framer-mkgQP framer-xgaixr" style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
              <div className="framer-bvg60a-container">
                <Suspense fallback={null}>
