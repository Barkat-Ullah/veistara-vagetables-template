...
import Header from "@/src/sections/404/Header";
import Header2 from "@/src/sections/404/Header2";
import Header3 from "@/src/sections/404/Header3";
import Section404 from "@/src/sections/404/Section404";
import Cta from "@/src/sections/404/Cta";
import Footer from "@/src/sections/404/Footer";
import Footer2 from "@/src/sections/404/Footer2";
import Footer3 from "@/src/sections/404/Footer3";
...
export default function Section404Page() {
  return (
    <body>
      ...
      {"\n\t\n\t"}
      <div id="main" data-framer-hydrate-v2={"{\"routeId\":\"sx6C8jla7\",\"localeId\":\"default\",\"breakpoints\":[{\"hash\":\"cwry8j\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1j3u1dr\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"fgc4a1\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1vvr1qc\",\"mediaQuery\":\"(max-width: 809.98px)\"},{\"hash\":\"22qbl\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1frv160\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"83oeot\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1wyxcdt\",\"mediaQuery\":\"(max-width: 809.98px)\"}]}"} data-framer-ssr-released-at="2026-08-06T12:57:44.116Z" data-framer-page-optimized-at="2026-08-07T04:38:26.803Z" data-framer-generated-page="">
        <Suspense fallback={null}>
          ...
          <div className="framer-Q2Ors framer-QrPZX framer-mkgQP framer-4RXUR framer-SQy1v framer-xo5li framer-xbNaX framer-22qbl" data-layout-template="true" style={{ "--hgcs32": "hidden", minHeight: "100vh", width: "auto" }}>
            ...
            <div data-framer-root="" className="framer-wvbXb framer-kRbhw framer-mkgQP framer-cwry8j" style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
              <div className="framer-1oav71j-container">
                <Suspense fallback={null}>
