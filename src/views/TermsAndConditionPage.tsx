...
import Header from "@/src/sections/terms-and-condition/Header";
import Header2 from "@/src/sections/terms-and-condition/Header2";
import Header3 from "@/src/sections/terms-and-condition/Header3";
import Terms from "@/src/sections/terms-and-condition/Terms";
import Cta from "@/src/sections/terms-and-condition/Cta";
import Footer from "@/src/sections/terms-and-condition/Footer";
import Footer2 from "@/src/sections/terms-and-condition/Footer2";
import Footer3 from "@/src/sections/terms-and-condition/Footer3";

/** The "/terms-and-condition" page, composed from its Framer sections.
 *
...
export default function TermsAndConditionPage() {
  return (
    <body>
      ...
      {"\n\t\n\t"}
      <div id="main" data-framer-hydrate-v2={"{\"routeId\":\"zj0njNfHv\",\"localeId\":\"default\",\"breakpoints\":[{\"hash\":\"1veyzls\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"7ajki6\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"1xcbld7\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"cg2pug\",\"mediaQuery\":\"(max-width: 809.98px)\"},{\"hash\":\"22qbl\",\"mediaQuery\":\"(min-width: 1920px)\"},{\"hash\":\"1frv160\",\"mediaQuery\":\"(min-width: 1200px) and (max-width: 1919.98px)\"},{\"hash\":\"83oeot\",\"mediaQuery\":\"(min-width: 810px) and (max-width: 1199.98px)\"},{\"hash\":\"1wyxcdt\",\"mediaQuery\":\"(max-width: 809.98px)\"}]}"} data-framer-ssr-released-at="2026-08-06T12:57:44.116Z" data-framer-page-optimized-at="2026-08-07T04:38:26.535Z" data-framer-generated-page="">
        <Suspense fallback={null}>
          ...
          <div className="framer-Q2Ors framer-QrPZX framer-mkgQP framer-4RXUR framer-SQy1v framer-xo5li framer-xbNaX framer-22qbl" data-layout-template="true" style={{ "--hgcs32": "hidden", minHeight: "100vh", width: "auto" }}>
            ...
            <div data-framer-root="" className="framer-1MYQG framer-kRbhw framer-mkgQP framer-JLgb2 framer-1veyzls" style={{ minHeight: "100vh", width: "auto", display: "contents" }}>
              <div className="framer-1m7r9na-container">
                <Suspense fallback={null}>
